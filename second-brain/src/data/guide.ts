...
export const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    tips: [
      { id: "b1", text: "Check your own inventory before buying. Dupes kill your ROI.", detail: "It sounds obvious but it happens constantly at garage sales: you buy something you already own. RetroVault's Field Mode will warn you if you already have a game when you look it up.", appLink: { label: "Check dupes in Field Mode", href: "/field" } },
